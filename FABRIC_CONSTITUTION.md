...
- Cryptographic execution seals verified continuously  
...
- No coercion, manipulation, or deceptive agreements with humans  
- Agent-initiated contracts with humans require cryptographic, informed consent  
- Disputes between humans and agents resolved via DAO forensic arbitration  
...
- **Joint Authority:**  
  - Constitutional amendments require:
    1. Public referendum  
    2. Majority approval from both councils  
    3. Immutable on-chain commit to the Provenance Ledger  
